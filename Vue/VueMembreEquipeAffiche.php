...
<form method="post">
    ...
    <div class="form-vips">
        ...
        <div id="form-item">
            ...
            <div>
                        <label id="filmLabel" for="special">Choisir Le Film :</label>
                        <select for="filmLabel" id="film" name="special" >

                        <?php foreach($elements as $film) :
                            
                            if($selectionne == $film->get_titre())
                            {
                            ?>
                                    <option value="<?= $film->get_titre() ?>"selected><?= $film->get_titre() ?> </option>
                            <?php
                            }
                            else 
                            {
                            ?>
                                    <option value="<?= $film->get_titre() ?>"><?= $film->get_titre() ?>  </option>
                        <?php }endforeach; ?>
            </div>
